...
- Initial release. Measures Cursor rules (`.cursor/rules/**/*.mdc` including
  ...
  `.codex/skills/`, anywhere in the tree), and MCP configuration
  (`.cursor/mcp.json`), verified against cursor.com/docs (Customize > Rules,
  Customize > MCP) rather than assumed from a general path table. See #78.
